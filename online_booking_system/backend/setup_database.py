...
def create_database():
    ...
    try:
        ...
        cursor.execute('''INSERT INTO vehicles (model, price_per_day, image_url, specifications, is_reserved, is_deleted)
                       VALUES 
                       ('Toyota Corolla', 30.00, 'toyota.jpeg', 'Automatic, 4-door, AC, Radio', 0, 0),
                       ('Honda Civic', 35.00, 'civic.jpeg', 'Manual, 4-door, AC, Radio', 0, 0),
                       ('Ford Mustang', 50.00, 'mustang.jpeg', 'Automatic, 2-door, AC, Radio, GPS', 0, 0),
                       ('Chevrolet Malibu', 40.00, 'chevrolet.jpeg', 'Automatic, 4-door, AC, Radio, Sunroof', 0, 0),
                       ('Tesla Model 3', 70.00, 'tesla.jpeg', 'Automatic, 4-door, AC, Radio, Electric', 0, 0);''')
